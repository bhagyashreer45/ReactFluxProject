...
// let ForumDispatcher=require('../dispatcher/ForumDispatcher');
// let ForumConstants=require('../constants/ForumConstants');

let answerData = {
    "1": {
        body: "Isn't that about tie travel?",
        correct: false
    },
    "2": {
        body: "React and Flux are a tool and methodologies for building the front end of web application.",
        correct: false
    },
    "3": {
...
let ForumStore = new EventEmitter();
